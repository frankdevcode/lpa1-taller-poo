...
class Comedor:
    ...
    def _calcular_capacidad_maxima(self) -> int:
        """Calcula la capacidad máxima de sillas basada en el área de la mesa."""
        if hasattr(self._mesa, 'area'):
            return max(4, int(self._mesa.area * 2.5))  # Aprox 1 silla por cada 0.4 m^2
        return 6
    ...
    def __str__(self) -> str:
        return f"Comedor '{self.nombre}': 1 Mesa y {len(self._sillas)} Silla(s)"
